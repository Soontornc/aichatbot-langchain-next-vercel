...
export async function POST() {
    ...
    //     temperature: 0.7, // ความสร้างสรรค์ของคำตอบ มีระดับ 0-1 // 0 คือ ตอบตรง ๆ // 1 คือ ตอบแบบสร้างสรรค์
    //     maxRetries: 2, // จำนวนครั้งสูงสุดในการลองใหม่
    //     maxOutputTokens: 2048, // จำนวนคำตอบต่ำสุดที่ต้องการมากกว่า 300 token ขึ้นไป (สำหรับ Gemini)
    // })
    ...
    // return NextResponse.json({ message: "Hello from Chat 01 - Start", response })
